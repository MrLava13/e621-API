...
trait traits {
    ...
    final private static function send(...$data){
     ...
     * @return resource
     */
    final private static function gen(string $method, array $other = []){
        $context = [
            "http" => [
                "method" => $method,
                "user_agent" => "phpE621/0.1 (by mrlavathirteen on e621, ran by " . Auth::user() . ")"
            ]
        ];
